...
{
  enum ARGS {
    CLIP, RADIUS, LIMIT, RADIUS_Y, YRADIUS_Y, LIMIT_Y, RADIUS_U, YRADIUS_U, LIMIT_U
...
{
  enum ARGS {
    CLIP, CHILD2, RADIUS, RANK, RADIUS_Y, YRADIUS_Y, RANK_Y, URANK_Y, RADIUS_U, YRADIUS_U, RANK_U, URANK_U
...
{
  enum ARGS {
    CLIP, RADIUS, PIXELS, RADIUS_Y, YRADIUS_Y, PIXELS_Y, RADIUS_U, YRADIUS_U, PIXELS_U
...
{
  enum ARGS {
    CLIP, CLIP2, RADIUS, PIXELS, RADIUS_Y, YRADIUS_Y, PIXELS_Y, RADIUS_U, YRADIUS_U, PIXELS_U
    , RADIUS_V, YRADIUS_V, PIXELS_V, WEIGHT, PLANAR
  };
